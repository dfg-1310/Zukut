...
/**
 * Purpose of class is to generate circular video views for OpenTok views
 */
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            if (mCurrentFrame != null && !mVideoDisabled) {
                ...
                Matrix.scaleM(mScaleMatrix, 0,
                        (mCurrentFrame.isMirroredX() ? -1.0f : 1.0f), 1, 1);

                // FIXME This code looks like the cause of the
                // "skipped xx frames!" warning
